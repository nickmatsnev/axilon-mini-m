      ...
      child: Scaffold(
        ...
        items: [
          BottomNavigationBarItem(
            ...
            label: translationProvider.t("Home"),
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.call_outlined),
            label: translationProvider.t("Calls"),
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.fact_check_outlined),
            label: translationProvider.t("Scenarios"),
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.settings_outlined),
            label: translationProvider.t("Settings"),
          ),
        ],
      ),
      ),
